...
미완료 체크 1건은 D-2 부트스트랩 행의 정확한 일 단위 시행일이 확인되지 않았기 때문이다. 신청 방법은
충북보건과학대학교 2026학년도 모집요강 p.1의 광역비자 제출 절차를 근거로 반영했다. 정확한 목록은
`extraction/common_v2/known_validation_gaps.txt`에서 관리한다.

## 보류·후속 작업

- D-2 정확한 일 단위 시행일을 확인할 충청북도·법무부 공식 공고 확보
